...
```bash
echo "deb [trusted=yes arch=all] https://raw.githubusercontent.com/ricardusmd/remotop/9da78da9de0868681750c39fba5e0627dfe2abdd/apt stable main" | sudo tee /etc/apt/sources.list.d/remotop.list
sudo apt update
